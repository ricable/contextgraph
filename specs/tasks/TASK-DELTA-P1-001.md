...
| NUM_EMBEDDERS constant | `crates/context-graph-core/src/johari/manager.rs` |
...
- MCP handler implementation (TASK-DELTA-P1-003)
- Entropy computation logic (TASK-DELTA-P1-002)
- Coherence computation logic (TASK-DELTA-P1-002)
...
///
/// Computes entropy (Delta-S) and coherence (Delta-C) changes when updating a vertex.
/// Per constitution.yaml gwt_tools, this is required for UTL learning.
///
/// # Constitution Reference
/// - delta_sc.Delta_S_methods: Per-embedder entropy computation
/// - delta_sc.Delta_C: alpha*Connectivity + beta*ClusterFit + gamma*Consistency (0.4, 0.4, 0.2)
...
///
/// Contains per-embedder and aggregate Delta-S/Delta-C values plus Johari classification.
///
/// # Constitution Reference
/// - utl.canonical: L = f((Delta-S * Delta-C) * w_e * cos phi)
...
pub struct ComputeDeltaScResponse {
    ...
    /// Based on (Delta-S, Delta-C) thresholds from constitution.
    pub johari_quadrants: [JohariQuadrant; 13],

    /// Aggregate Johari classification (based on aggregate Delta-S and Delta-C).
    pub johari_aggregate: JohariQuadrant,

    /// Combined UTL learning potential: Delta-S * Delta-C.
...
- The types define the contract that TASK-DELTA-P1-002 and TASK-DELTA-P1-003 will implement
